...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcAlignmentHorizontal : public IfcLinearElement
	{ 
	public:
		IfcAlignmentHorizontal() = default;
		IfcAlignmentHorizontal( int id );
		...
		virtual uint32_t classID() const { return 1545765605; }
