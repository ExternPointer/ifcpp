...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcAlignmentVertical : public IfcLinearElement
	{ 
	public:
		IfcAlignmentVertical() = default;
		IfcAlignmentVertical( int id );
		...
		virtual uint32_t classID() const { return 1662888072; }
