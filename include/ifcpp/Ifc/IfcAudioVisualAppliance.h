...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcAudioVisualApplianceTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcAudioVisualAppliance : public IfcFlowTerminal
	{ 
	public:
		IfcAudioVisualAppliance() = default;
		...
		virtual uint32_t classID() const { return 277319702; }
