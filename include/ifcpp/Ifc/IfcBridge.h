...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcBridgeTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcBridge : public IfcFacility
	{ 
	public:
		IfcBridge() = default;
		IfcBridge( int id );
		...
		virtual uint32_t classID() const { return 644574406; }
		...
		// IfcBridge -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcBridgeTypeEnum>								m_PredefinedType;			//optional
	};
}
