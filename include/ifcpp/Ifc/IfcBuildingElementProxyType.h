...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcBuildingElementProxyTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcBuildingElementProxyType : public IfcBuiltElementType
	{ 
	public:
		...
		virtual uint32_t classID() const { return 1909888760; }
