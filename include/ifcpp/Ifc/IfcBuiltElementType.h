...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcBuiltElementType : public IfcElementType
	{ 
	public:
		IfcBuiltElementType() = default;
		IfcBuiltElementType( int id );
		...
		virtual uint32_t classID() const { return 1626504194; }
