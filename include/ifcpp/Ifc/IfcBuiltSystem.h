...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcBuiltSystemTypeEnum;
	...
	public:
		...
		virtual uint32_t classID() const { return 3862327254; }
		...
		// IfcBuiltSystem -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcBuiltSystemTypeEnum>							m_PredefinedType;			//optional
