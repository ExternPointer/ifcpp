...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcCableCarrierFittingTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcCableCarrierFitting : public IfcFlowFitting
	{ 
	public:
		IfcCableCarrierFitting() = default;
		...
		virtual uint32_t classID() const { return 635142910; }
