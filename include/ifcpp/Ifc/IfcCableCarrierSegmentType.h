...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcCableCarrierSegmentTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcCableCarrierSegmentType : public IfcFlowSegmentType
	{
	public:
		...
		virtual uint32_t classID() const { return 3293546465; }
