...
#include "IfcDeepFoundation.h"
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcCaissonFoundationTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcCaissonFoundation : public IfcDeepFoundation
	{ 
	public:
		IfcCaissonFoundation() = default;
		IfcCaissonFoundation( int id );
		...
		virtual uint32_t classID() const { return 3999819293; }
		...
		// attributes:
		shared_ptr<IfcCaissonFoundationTypeEnum>					m_PredefinedType;			//optional
	};
}
