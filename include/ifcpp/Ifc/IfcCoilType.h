...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcCoilTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcCoilType : public IfcEnergyConversionDeviceType
	{ 
	public:
		IfcCoilType() = default;
		IfcCoilType( int id );
		...
		virtual uint32_t classID() const { return 2301859152; }
