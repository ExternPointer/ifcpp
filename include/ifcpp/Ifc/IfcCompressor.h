...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcCompressorTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcCompressor : public IfcFlowMovingDevice
	{
	public:
		IfcCompressor() = default;
		...
		virtual uint32_t classID() const { return 3571504051; }
