...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcCondenserTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcCondenserType : public IfcEnergyConversionDeviceType
	{ 
	public:
		...
		virtual uint32_t classID() const { return 2816379211; }
