...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcConstructionProductResourceType : public IfcConstructionResourceType
	{
	public:
		IfcConstructionProductResourceType() = default;
		...
		virtual uint32_t classID() const { return 1525564444; }
