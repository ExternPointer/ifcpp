...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcConstructionResourceType : public IfcTypeResource
	{
	public:
		IfcConstructionResourceType() = default;
		...
		virtual uint32_t classID() const { return 2574617495; }
