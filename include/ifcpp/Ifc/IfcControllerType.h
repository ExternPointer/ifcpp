...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcControllerTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcControllerType : public IfcDistributionControlElementType
	{
	public:
		...
		virtual uint32_t classID() const { return 578613899; }
