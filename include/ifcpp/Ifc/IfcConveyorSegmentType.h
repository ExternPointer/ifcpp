...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcConveyorSegmentTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcConveyorSegmentType : public IfcFlowSegmentType
	{
	public:
		IfcConveyorSegmentType() = default;
		IfcConveyorSegmentType( int id );
		...
		virtual uint32_t classID() const { return 2940368186; }
		...
		// attributes:
		shared_ptr<IfcConveyorSegmentTypeEnum>				m_PredefinedType;
	};
}
