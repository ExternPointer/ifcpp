...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcCourse : public IfcBuiltElement
	{
	public:
		IfcCourse() = default;
		IfcCourse( int id );
		...
		virtual uint32_t classID() const { return 1502416096; }
		...
		// IfcCourse -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcCourseTypeEnum>								m_PredefinedType;			//optional
	};
}
