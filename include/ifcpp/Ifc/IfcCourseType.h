...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcCourseTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcCourseType : public IfcBuiltElementType
	{
	public:
		IfcCourseType() = default;
		IfcCourseType( int id );
		...
		virtual uint32_t classID() const { return 4189326743; }
		...
		// IfcCourseType -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcCourseTypeEnum>						m_PredefinedType;
	};
}
