...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcCoveringTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcCoveringType : public IfcBuiltElementType
	{ 
	public:
		...
		virtual uint32_t classID() const { return 1916426348; }
