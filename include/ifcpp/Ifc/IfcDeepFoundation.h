...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcDeepFoundation : public IfcBuiltElement
	{ 
	public:
		IfcDeepFoundation() = default;
		IfcDeepFoundation( int id );
		...
		virtual uint32_t classID() const { return 3426335179; }
