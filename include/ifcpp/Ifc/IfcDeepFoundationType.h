...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcDeepFoundationType : public IfcBuiltElementType
	{
	public:
		IfcDeepFoundationType() = default;
		IfcDeepFoundationType( int id );
		...
		virtual uint32_t classID() const { return 1306400036; }
