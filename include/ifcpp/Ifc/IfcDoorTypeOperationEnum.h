...
namespace IFC4X3
{
	...
	public:
		...
		{
			ENUM_DOUBLE_PANEL_DOUBLE_SWING,
			ENUM_DOUBLE_PANEL_FOLDING,
			ENUM_DOUBLE_PANEL_LIFTING_VERTICAL,
			ENUM_DOUBLE_PANEL_SINGLE_SWING,
			ENUM_DOUBLE_PANEL_SINGLE_SWING_OPPOSITE_LEFT,
			ENUM_DOUBLE_PANEL_SINGLE_SWING_OPPOSITE_RIGHT,
			ENUM_DOUBLE_PANEL_SLIDING,
