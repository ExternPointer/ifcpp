...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcDuctSegmentTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcDuctSegmentType : public IfcFlowSegmentType
	{
	public:
		...
		virtual uint32_t classID() const { return 3760055223; }
