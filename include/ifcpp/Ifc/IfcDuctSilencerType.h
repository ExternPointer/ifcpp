...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcDuctSilencerTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcDuctSilencerType : public IfcFlowTreatmentDeviceType
	{ 
	public:
		...
		virtual uint32_t classID() const { return 2030761528; }
