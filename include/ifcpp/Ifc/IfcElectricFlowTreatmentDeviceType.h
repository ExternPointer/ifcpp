...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcElectricFlowTreatmentDeviceType : public IfcFlowTreatmentDeviceType
	{ 
	public:
		IfcElectricFlowTreatmentDeviceType() = default;
		IfcElectricFlowTreatmentDeviceType( int id );
		...
		virtual uint32_t classID() const { return 2142170206; }
		...
		// attributes:
		shared_ptr<IfcElectricFlowTreatmentDeviceTypeEnum>	m_PredefinedType;
	};
}
