...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcElectricGeneratorTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcElectricGenerator : public IfcEnergyConversionDevice
	{ 
	public:
		IfcElectricGenerator() = default;
		...
		virtual uint32_t classID() const { return 264262732; }
