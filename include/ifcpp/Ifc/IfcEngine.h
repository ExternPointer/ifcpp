...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcEngineTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcEngine : public IfcEnergyConversionDevice
	{
	public:
		IfcEngine() = default;
		IfcEngine( int id );
		...
		virtual uint32_t classID() const { return 2814081492; }
