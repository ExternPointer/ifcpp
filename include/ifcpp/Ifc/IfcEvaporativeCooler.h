...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcEvaporativeCooler : public IfcEnergyConversionDevice
	{
	public:
		IfcEvaporativeCooler() = default;
		...
		virtual uint32_t classID() const { return 3747195512; }
