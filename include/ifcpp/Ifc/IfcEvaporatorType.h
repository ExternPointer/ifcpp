...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcEvaporatorTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcEvaporatorType : public IfcEnergyConversionDeviceType
	{ 
	public:
		IfcEvaporatorType() = default;
		...
		virtual uint32_t classID() const { return 3390157468; }
