...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcEventTypeEnum;
	class IFCQUERY_EXPORT IfcEventTriggerTypeEnum;
	class IFCQUERY_EXPORT IfcLabel;
	class IFCQUERY_EXPORT IfcEventTime;
	//ENTITY
	...
	public:
		...
		virtual uint32_t classID() const { return 4148101412; }
