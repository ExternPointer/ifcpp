...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcExternalSpatialStructureElement : public IfcSpatialElement
	{ 
	public:
		IfcExternalSpatialStructureElement() = default;
		...
		virtual uint32_t classID() const { return 2853485674; }
