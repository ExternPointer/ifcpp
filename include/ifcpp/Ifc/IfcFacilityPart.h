...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcFacilityUsageEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcFacilityPart : public IfcSpatialStructureElement
	{ 
	public:
		IfcFacilityPart() = default;
		IfcFacilityPart( int id );
		...
		virtual uint32_t classID() const { return 1310830890; }
