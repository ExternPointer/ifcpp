...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcFilterTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcFilterType : public IfcFlowTreatmentDeviceType
	{
	public:
		...
		virtual uint32_t classID() const { return 1810631287; }
