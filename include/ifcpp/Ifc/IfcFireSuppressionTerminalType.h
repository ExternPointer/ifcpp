...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcFireSuppressionTerminalType : public IfcFlowTerminalType
	{
	public:
		IfcFireSuppressionTerminalType() = default;
		...
		virtual uint32_t classID() const { return 4222183408; }
