...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcFlowMeterTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcFlowMeterType : public IfcFlowControllerType
	{
	public:
		...
		virtual uint32_t classID() const { return 3815607619; }
