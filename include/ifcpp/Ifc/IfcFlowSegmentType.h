...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcFlowSegmentType : public IfcDistributionFlowElementType
	{
	public:
		IfcFlowSegmentType() = default;
		...
		virtual uint32_t classID() const { return 1834744321; }
