...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcFlowStorageDevice : public IfcDistributionFlowElement
	{ 
	public:
		IfcFlowStorageDevice() = default;
		...
		virtual uint32_t classID() const { return 707683696; }
