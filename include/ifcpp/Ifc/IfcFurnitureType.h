...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcAssemblyPlaceEnum;
	class IFCQUERY_EXPORT IfcFurnitureTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcFurnitureType : public IfcFurnishingElementType
	{ 
	public:
		...
		virtual uint32_t classID() const { return 1268542332; }
