...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcGeotechnicalElement : public IfcElement
	{
	public:
		IfcGeotechnicalElement() = default;
		IfcGeotechnicalElement( int id );
		...
		virtual uint32_t classID() const { return 4230923436; }
