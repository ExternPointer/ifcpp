...
#include "IfcSpatialReferenceSelect.h"
#include "IfcObject.h"
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcRelAssignsToGroup;
	class IFCQUERY_EXPORT IfcRelReferencedInSpatialStructure;
	//ENTITY
	class IFCQUERY_EXPORT IfcGroup : virtual public IfcSpatialReferenceSelect, public IfcObject
	{
	public:
		IfcGroup() = default;
		IfcGroup( int id );
		...
		virtual uint32_t classID() const { return 2706460486; }
