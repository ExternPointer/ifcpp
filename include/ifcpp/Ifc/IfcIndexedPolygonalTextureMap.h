...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcIndexedPolygonalTextureMap : public IfcIndexedTextureMap
	{
	public:
		IfcIndexedPolygonalTextureMap() = default;
		IfcIndexedPolygonalTextureMap( int id );
		...
		virtual uint32_t classID() const { return 3465909080; }
		...
		// attributes:
		std::vector<shared_ptr<IfcTextureCoordinateIndices> >	m_TexCoordIndices;
	};
}
