...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcLightFixtureTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcLightFixtureType : public IfcFlowTerminalType
	{
	public:
		...
		virtual uint32_t classID() const { return 1161773419; }
