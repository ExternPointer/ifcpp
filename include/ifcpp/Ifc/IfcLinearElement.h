...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcLinearElement : public IfcProduct
	{
	public:
		IfcLinearElement() = default;
		IfcLinearElement( int id );
		...
		virtual uint32_t classID() const { return 2176059722; }
