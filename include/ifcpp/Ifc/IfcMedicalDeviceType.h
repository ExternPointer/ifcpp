...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcMedicalDeviceTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcMedicalDeviceType : public IfcFlowTerminalType
	{
	public:
		IfcMedicalDeviceType() = default;
		...
		virtual uint32_t classID() const { return 1114901282; }
