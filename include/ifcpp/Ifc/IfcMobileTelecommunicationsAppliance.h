...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcMobileTelecommunicationsAppliance : public IfcFlowTerminal
	{ 
	public:
		IfcMobileTelecommunicationsAppliance() = default;
		IfcMobileTelecommunicationsAppliance( int id );
		...
		virtual uint32_t classID() const { return 2078563270; }
		...
		// attributes:
		shared_ptr<IfcMobileTelecommunicationsApplianceTypeEnum>	m_PredefinedType;			//optional
	};
}
