...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcMobileTelecommunicationsApplianceTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcMobileTelecommunicationsApplianceType : public IfcFlowTerminalType
	{ 
	public:
		IfcMobileTelecommunicationsApplianceType() = default;
		IfcMobileTelecommunicationsApplianceType( int id );
		...
		virtual uint32_t classID() const { return 1950438474; }
		...
		// attributes:
		shared_ptr<IfcMobileTelecommunicationsApplianceTypeEnum>	m_PredefinedType;
	};
}
