...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcRelAssigns;
	class IFCQUERY_EXPORT IfcRelNests;
	class IFCQUERY_EXPORT IfcRelDeclares;
	class IFCQUERY_EXPORT IfcRelAggregates;
	...
	public:
		...
		virtual uint32_t classID() const { return 219451334; }
