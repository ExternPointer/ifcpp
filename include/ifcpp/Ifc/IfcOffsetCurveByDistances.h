...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcPointByDistanceExpression;
	...
	public:
		...
		virtual uint32_t classID() const { return 2485787929; }
		...
		// attributes:
		std::vector<shared_ptr<IfcPointByDistanceExpression> >	m_OffsetValues;
