...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcPavement : public IfcBuiltElement
	{ 
	public:
		IfcPavement() = default;
		IfcPavement( int id );
		...
		virtual uint32_t classID() const { return 1383356374; }
		...
		// IfcPavement -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcPavementTypeEnum>								m_PredefinedType;			//optional
	};
}
