...
namespace IFC4X3
{
	...
	class IFCQUERY_EXPORT IfcPhysicalComplexQuantity;
	//ENTITY
	class IFCQUERY_EXPORT IfcPhysicalQuantity : virtual public IfcResourceObjectSelect, public BuildingEntity
	{
	public:
		...
		virtual uint32_t classID() const { return 2483315170; }
