...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcPipeFittingTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcPipeFittingType : public IfcFlowFittingType
	{ 
	public:
		...
		virtual uint32_t classID() const { return 804291784; }
