...
namespace IFC4X3
{
	...
	public:
		...
		virtual uint32_t classID() const { return 3381221214; }
		...
		// IfcPolynomialCurve -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcPlacement>								m_Position;
		std::vector<shared_ptr<IfcReal> >						m_CoefficientsX;			//optional
		std::vector<shared_ptr<IfcReal> >						m_CoefficientsY;			//optional
