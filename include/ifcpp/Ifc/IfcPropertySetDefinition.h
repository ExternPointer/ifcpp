...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcPropertySetDefinition : virtual public IfcPropertySetDefinitionSelect, public IfcPropertyDefinition
	{ 
	public:
		...
		virtual uint32_t classID() const { return 3357820518; }
