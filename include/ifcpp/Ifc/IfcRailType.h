...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcRailType : public IfcBuiltElementType
	{
	public:
		IfcRailType() = default;
		IfcRailType( int id );
		...
		virtual uint32_t classID() const { return 1763565496; }
		...
		// IfcRailType -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcRailTypeEnum>							m_PredefinedType;
	};
}
