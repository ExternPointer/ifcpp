...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcRailingTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcRailingType : public IfcBuiltElementType
	{
	public:
		...
		virtual uint32_t classID() const { return 2893384427; }
