...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcRailwayTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcRailway : public IfcFacility
	{ 
	public:
		IfcRailway() = default;
		IfcRailway( int id );
		...
		virtual uint32_t classID() const { return 3992365140; }
		...
		// IfcRailway -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcRailwayTypeEnum>								m_PredefinedType;			//optional
	};
}
