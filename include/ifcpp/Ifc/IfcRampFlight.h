...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcRampFlightTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcRampFlight : public IfcBuiltElement
	{ 
	public:
		IfcRampFlight() = default;
		...
		virtual uint32_t classID() const { return 3283111854; }
