...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcDistributionControlElement;
	class IFCQUERY_EXPORT IfcDistributionFlowElement;
	//ENTITY
	class IFCQUERY_EXPORT IfcRelFlowControlElements : public IfcRelConnects
	{ 
	public:
		...
		virtual uint32_t classID() const { return 279856033; }
