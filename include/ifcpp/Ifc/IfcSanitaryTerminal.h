...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcSanitaryTerminalTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcSanitaryTerminal : public IfcFlowTerminal
	{
	public:
		IfcSanitaryTerminal() = default;
		...
		virtual uint32_t classID() const { return 3053780830; }
