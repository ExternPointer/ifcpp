...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcSegmentedReferenceCurve : public IfcCompositeCurve
	{ 
	public:
		IfcSegmentedReferenceCurve() = default;
		IfcSegmentedReferenceCurve( int id );
		...
		virtual uint32_t classID() const { return 544395925; }
