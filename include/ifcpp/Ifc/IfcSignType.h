...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcSignType : public IfcElementComponentType
	{
	public:
		IfcSignType() = default;
		IfcSignType( int id );
		...
		virtual uint32_t classID() const { return 3599934289; }
		...
		// IfcSignType -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcSignTypeEnum>							m_PredefinedType;
	};
}
