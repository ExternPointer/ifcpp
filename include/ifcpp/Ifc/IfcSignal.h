...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcSignal : public IfcFlowTerminal
	{ 
	public:
		IfcSignal() = default;
		IfcSignal( int id );
		...
		virtual uint32_t classID() const { return 991950508; }
		...
		// IfcSignal -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcSignalTypeEnum>								m_PredefinedType;			//optional
	};
}
