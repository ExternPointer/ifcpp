...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcSolarDeviceTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcSolarDevice : public IfcEnergyConversionDevice
	{ 
	public:
		IfcSolarDevice() = default;
		...
		virtual uint32_t classID() const { return 3420628829; }
