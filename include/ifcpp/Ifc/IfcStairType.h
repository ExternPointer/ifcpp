...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcStairTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcStairType : public IfcBuiltElementType
	{
	public:
		IfcStairType() = default;
		IfcStairType( int id );
		...
		virtual uint32_t classID() const { return 338393293; }
