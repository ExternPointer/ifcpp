...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcStructuralLoad;
	class IFCQUERY_EXPORT IfcGlobalOrLocalEnum;
	class IFCQUERY_EXPORT IfcRelConnectsStructuralActivity;
	//ENTITY
	class IFCQUERY_EXPORT IfcStructuralActivity : public IfcProduct
	{
	public:
		...
		virtual uint32_t classID() const { return 3544373492; }
