...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcLoadGroupTypeEnum;
	class IFCQUERY_EXPORT IfcActionTypeEnum;
	class IFCQUERY_EXPORT IfcActionSourceTypeEnum;
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcStructuralLoadGroup : public IfcGroup
	{
	public:
		...
		virtual uint32_t classID() const { return 1252848954; }
