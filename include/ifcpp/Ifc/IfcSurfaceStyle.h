...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcSurfaceSide;
	class IFCQUERY_EXPORT IfcSurfaceStyleElementSelect;
	//ENTITY
	class IFCQUERY_EXPORT IfcSurfaceStyle : public IfcPresentationStyle
	{
	public:
		...
		virtual uint32_t classID() const { return 1300840506; }
