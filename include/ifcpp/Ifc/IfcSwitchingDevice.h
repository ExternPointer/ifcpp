...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcSwitchingDeviceTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcSwitchingDevice : public IfcFlowController
	{
	public:
		...
		virtual uint32_t classID() const { return 1162798199; }
