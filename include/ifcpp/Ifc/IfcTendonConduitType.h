...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcTendonConduitType : public IfcReinforcingElementType
	{
	public:
		IfcTendonConduitType() = default;
		IfcTendonConduitType( int id );
		...
		virtual uint32_t classID() const { return 2281632017; }
