...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcTransformerTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcTransformerType : public IfcEnergyConversionDeviceType
	{
	public:
		...
		virtual uint32_t classID() const { return 1692211062; }
