...
{
	//ENTITY
	class IFCQUERY_EXPORT IfcTransportationDeviceType : public IfcElementType
	{ 
	public:
		IfcTransportationDeviceType() = default;
		IfcTransportationDeviceType( int id );
		...
		virtual uint32_t classID() const { return 3665877780; }
