...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcTypeProcess : virtual public IfcProcessSelect, public IfcTypeObject
	{
	public:
		IfcTypeProcess() = default;
		...
		virtual uint32_t classID() const { return 3736923433; }
