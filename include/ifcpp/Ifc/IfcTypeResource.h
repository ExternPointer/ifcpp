...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcTypeResource : virtual public IfcResourceSelect, public IfcTypeObject
	{ 
	public:
		IfcTypeResource() = default;
		...
		virtual uint32_t classID() const { return 3698973494; }
