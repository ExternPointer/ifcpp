...
namespace IFC4X3
{
	...
	//ENTITY
	class IFCQUERY_EXPORT IfcVehicleType : public IfcTransportationDeviceType
	{
	public:
		IfcVehicleType() = default;
		IfcVehicleType( int id );
		...
		virtual uint32_t classID() const { return 3651464721; }
		...
		// IfcVehicleType -----------------------------------------------------------
		// attributes:
		shared_ptr<IfcVehicleTypeEnum>						m_PredefinedType;
	};
}
