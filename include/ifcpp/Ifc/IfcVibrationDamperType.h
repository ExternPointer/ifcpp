...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcVibrationDamperTypeEnum;
	//ENTITY
	class IFCQUERY_EXPORT IfcVibrationDamperType : public IfcElementComponentType
	{ 
	public:
		IfcVibrationDamperType() = default;
		IfcVibrationDamperType( int id );
		...
		virtual uint32_t classID() const { return 3956297820; }
		...
		// attributes:
		shared_ptr<IfcVibrationDamperTypeEnum>				m_PredefinedType;
	};
}
