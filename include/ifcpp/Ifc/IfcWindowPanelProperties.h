...
namespace IFC4X3
{
	class IFCQUERY_EXPORT IfcWindowPanelOperationEnum;
	class IFCQUERY_EXPORT IfcWindowPanelPositionEnum;
	class IFCQUERY_EXPORT IfcPositiveLengthMeasure;
	class IFCQUERY_EXPORT IfcShapeAspect;
	//ENTITY
	class IFCQUERY_EXPORT IfcWindowPanelProperties : public IfcPreDefinedPropertySet
	{ 
	public:
		...
		virtual uint32_t classID() const { return 512836454; }
