...
// ENTITY IfcBeamType 
IFC4X3::IfcBeamType::IfcBeamType( int tag ) { m_tag = tag; }
void IFC4X3::IfcBeamType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCBEAMTYPE" << "(";
...
void IFC4X3::IfcBeamType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcBeamType::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcBeamType, expecting 10, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcBeamTypeEnum::createObjectFromSTEP( args[9], map, errorStream );
}
void IFC4X3::IfcBeamType::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcBuiltElementType::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IFC4X3::IfcBeamType::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcBuiltElementType::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcBeamType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcBuiltElementType::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcBeamType::unlinkFromInverseCounterparts()
{
