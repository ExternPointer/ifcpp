...
IFC4X3::IfcBoundaryNodeConditionWarping::IfcBoundaryNodeConditionWarping( int tag ) { m_tag = tag; }
void IFC4X3::IfcBoundaryNodeConditionWarping::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCBOUNDARYNODECONDITIONWARPING" << "(";
...
void IFC4X3::IfcBoundaryNodeConditionWarping::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcBoundaryNodeConditionWarping::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 8 ){ std::stringstream err; err << "Wrong parameter count for entity IfcBoundaryNodeConditionWarping, expecting 8, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_WarpingStiffness = IfcWarpingStiffnessSelect::createObjectFromSTEP( args[7], map, errorStream );
}
void IFC4X3::IfcBoundaryNodeConditionWarping::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcBoundaryNodeCondition::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "WarpingStiffness", m_WarpingStiffness ) );
}
void IFC4X3::IfcBoundaryNodeConditionWarping::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcBoundaryNodeCondition::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcBoundaryNodeConditionWarping::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcBoundaryNodeCondition::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcBoundaryNodeConditionWarping::unlinkFromInverseCounterparts()
{
