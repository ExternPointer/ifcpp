...
IFC4X3::IfcBridgePart::IfcBridgePart( int tag ) { m_tag = tag; }
void IFC4X3::IfcBridgePart::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCBRIDGEPART" << "(";
...
void IFC4X3::IfcBridgePart::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcBridgePart::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 11 ){ std::stringstream err; err << "Wrong parameter count for entity IfcBridgePart, expecting 11, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcBridgePartTypeEnum::createObjectFromSTEP( args[10], map, errorStream );
}
void IFC4X3::IfcBridgePart::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcFacilityPart::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IFC4X3::IfcBridgePart::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcFacilityPart::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcBridgePart::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcFacilityPart::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcBridgePart::unlinkFromInverseCounterparts()
{
