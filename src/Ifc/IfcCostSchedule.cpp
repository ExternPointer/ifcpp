...
void IFC4X3::IfcCostSchedule::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcCostSchedule::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcCostSchedule, expecting 10, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcCostScheduleTypeEnum::createObjectFromSTEP( args[6], map, errorStream );
	m_Status = IfcLabel::createObjectFromSTEP( args[7], map, errorStream );
	m_SubmittedOn = IfcDateTime::createObjectFromSTEP( args[8], map, errorStream );
	m_UpdateDate = IfcDateTime::createObjectFromSTEP( args[9], map, errorStream );
}
void IFC4X3::IfcCostSchedule::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
...
void IFC4X3::IfcCostSchedule::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcControl::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcCostSchedule::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcControl::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcCostSchedule::unlinkFromInverseCounterparts()
{
