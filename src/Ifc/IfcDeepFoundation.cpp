...
IFC4X3::IfcDeepFoundation::IfcDeepFoundation( int tag ) { m_tag = tag; }
void IFC4X3::IfcDeepFoundation::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCDEEPFOUNDATION" << "(";
...
void IFC4X3::IfcDeepFoundation::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcDeepFoundation::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 8 ){ std::stringstream err; err << "Wrong parameter count for entity IfcDeepFoundation, expecting 8, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IFC4X3::IfcDeepFoundation::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcBuiltElement::getAttributes( vec_attributes );
}
void IFC4X3::IfcDeepFoundation::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcBuiltElement::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcDeepFoundation::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcBuiltElement::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcDeepFoundation::unlinkFromInverseCounterparts()
{
