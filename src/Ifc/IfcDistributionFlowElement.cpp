...
IFC4X3::IfcDistributionFlowElement::IfcDistributionFlowElement( int tag ) { m_tag = tag; }
void IFC4X3::IfcDistributionFlowElement::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCDISTRIBUTIONFLOWELEMENT" << "(";
...
void IFC4X3::IfcDistributionFlowElement::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcDistributionFlowElement::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 8 ){ std::stringstream err; err << "Wrong parameter count for entity IfcDistributionFlowElement, expecting 8, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IFC4X3::IfcDistributionFlowElement::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
...
void IFC4X3::IfcDistributionFlowElement::unlinkFromInverseCounterparts()
{
