...
// ENTITY IfcDoorType 
IFC4X3::IfcDoorType::IfcDoorType( int tag ) { m_tag = tag; }
void IFC4X3::IfcDoorType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCDOORTYPE" << "(";
...
void IFC4X3::IfcDoorType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcDoorType::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 13 ){ std::stringstream err; err << "Wrong parameter count for entity IfcDoorType, expecting 13, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcDoorTypeEnum::createObjectFromSTEP( args[9], map, errorStream );
	m_OperationType = IfcDoorTypeOperationEnum::createObjectFromSTEP( args[10], map, errorStream );
	m_ParameterTakesPrecedence = IfcBoolean::createObjectFromSTEP( args[11], map, errorStream );
	m_UserDefinedOperationType = IfcLabel::createObjectFromSTEP( args[12], map, errorStream );
}
void IFC4X3::IfcDoorType::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
...
void IFC4X3::IfcDoorType::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcBuiltElementType::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcDoorType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcBuiltElementType::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcDoorType::unlinkFromInverseCounterparts()
{
