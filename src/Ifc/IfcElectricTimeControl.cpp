...
IFC4X3::IfcElectricTimeControl::IfcElectricTimeControl( int tag ) { m_tag = tag; }
void IFC4X3::IfcElectricTimeControl::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCELECTRICTIMECONTROL" << "(";
...
void IFC4X3::IfcElectricTimeControl::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcElectricTimeControl::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcElectricTimeControl, expecting 9, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcElectricTimeControlTypeEnum::createObjectFromSTEP( args[8], map, errorStream );
}
void IFC4X3::IfcElectricTimeControl::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcFlowController::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IFC4X3::IfcElectricTimeControl::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcFlowController::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcElectricTimeControl::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcFlowController::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcElectricTimeControl::unlinkFromInverseCounterparts()
{
