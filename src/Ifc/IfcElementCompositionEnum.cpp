...
shared_ptr<IFC4X3::IfcElementCompositionEnum> IFC4X3::IfcElementCompositionEnum::createObjectFromSTEP( const std::string& arg, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
