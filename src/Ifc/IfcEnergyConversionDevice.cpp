...
IFC4X3::IfcEnergyConversionDevice::IfcEnergyConversionDevice( int tag ) { m_tag = tag; }
void IFC4X3::IfcEnergyConversionDevice::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCENERGYCONVERSIONDEVICE" << "(";
...
void IFC4X3::IfcEnergyConversionDevice::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcEnergyConversionDevice::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 8 ){ std::stringstream err; err << "Wrong parameter count for entity IfcEnergyConversionDevice, expecting 8, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IFC4X3::IfcEnergyConversionDevice::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcDistributionFlowElement::getAttributes( vec_attributes );
}
void IFC4X3::IfcEnergyConversionDevice::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcDistributionFlowElement::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcEnergyConversionDevice::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcDistributionFlowElement::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcEnergyConversionDevice::unlinkFromInverseCounterparts()
{
