...
IFC4X3::IfcFacilityPart::IfcFacilityPart( int tag ) { m_tag = tag; }
void IFC4X3::IfcFacilityPart::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCFACILITYPART" << "(";
...
void IFC4X3::IfcFacilityPart::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcFacilityPart::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcFacilityPart, expecting 10, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IFC4X3::IfcFacilityPart::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcSpatialStructureElement::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "UsageType", m_UsageType ) );
}
void IFC4X3::IfcFacilityPart::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcSpatialStructureElement::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcFacilityPart::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcSpatialStructureElement::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcFacilityPart::unlinkFromInverseCounterparts()
{
