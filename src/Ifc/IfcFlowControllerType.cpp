...
IFC4X3::IfcFlowControllerType::IfcFlowControllerType( int tag ) { m_tag = tag; }
void IFC4X3::IfcFlowControllerType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCFLOWCONTROLLERTYPE" << "(";
...
void IFC4X3::IfcFlowControllerType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcFlowControllerType::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcFlowControllerType, expecting 9, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IFC4X3::IfcFlowControllerType::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcDistributionFlowElementType::getAttributes( vec_attributes );
}
void IFC4X3::IfcFlowControllerType::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcDistributionFlowElementType::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcFlowControllerType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcDistributionFlowElementType::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcFlowControllerType::unlinkFromInverseCounterparts()
{
