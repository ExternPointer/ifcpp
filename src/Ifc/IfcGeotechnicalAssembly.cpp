...
IFC4X3::IfcGeotechnicalAssembly::IfcGeotechnicalAssembly( int tag ) { m_tag = tag; }
void IFC4X3::IfcGeotechnicalAssembly::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCGEOTECHNICALASSEMBLY" << "(";
...
void IFC4X3::IfcGeotechnicalAssembly::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcGeotechnicalAssembly::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 8 ){ std::stringstream err; err << "Wrong parameter count for entity IfcGeotechnicalAssembly, expecting 8, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IFC4X3::IfcGeotechnicalAssembly::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcGeotechnicalElement::getAttributes( vec_attributes );
}
void IFC4X3::IfcGeotechnicalAssembly::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcGeotechnicalElement::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcGeotechnicalAssembly::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcGeotechnicalElement::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcGeotechnicalAssembly::unlinkFromInverseCounterparts()
{
