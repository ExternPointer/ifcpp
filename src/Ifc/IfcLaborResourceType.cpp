...
IFC4X3::IfcLaborResourceType::IfcLaborResourceType( int tag ) { m_tag = tag; }
void IFC4X3::IfcLaborResourceType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCLABORRESOURCETYPE" << "(";
...
void IFC4X3::IfcLaborResourceType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcLaborResourceType::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 12 ){ std::stringstream err; err << "Wrong parameter count for entity IfcLaborResourceType, expecting 12, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcLaborResourceTypeEnum::createObjectFromSTEP( args[11], map, errorStream );
}
void IFC4X3::IfcLaborResourceType::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcConstructionResourceType::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IFC4X3::IfcLaborResourceType::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcConstructionResourceType::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcLaborResourceType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcConstructionResourceType::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcLaborResourceType::unlinkFromInverseCounterparts()
{
