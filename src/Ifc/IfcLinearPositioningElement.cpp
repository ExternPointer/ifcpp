...
IFC4X3::IfcLinearPositioningElement::IfcLinearPositioningElement( int tag ) { m_tag = tag; }
void IFC4X3::IfcLinearPositioningElement::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCLINEARPOSITIONINGELEMENT" << "(";
...
void IFC4X3::IfcLinearPositioningElement::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcLinearPositioningElement::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 7 ){ std::stringstream err; err << "Wrong parameter count for entity IfcLinearPositioningElement, expecting 7, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IFC4X3::IfcLinearPositioningElement::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcPositioningElement::getAttributes( vec_attributes );
}
void IFC4X3::IfcLinearPositioningElement::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcPositioningElement::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcLinearPositioningElement::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcPositioningElement::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcLinearPositioningElement::unlinkFromInverseCounterparts()
{
