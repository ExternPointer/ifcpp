...
IFC4X3::IfcMechanicalFastener::IfcMechanicalFastener( int tag ) { m_tag = tag; }
void IFC4X3::IfcMechanicalFastener::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCMECHANICALFASTENER" << "(";
...
void IFC4X3::IfcMechanicalFastener::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcMechanicalFastener::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 11 ){ std::stringstream err; err << "Wrong parameter count for entity IfcMechanicalFastener, expecting 11, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_NominalDiameter = IfcPositiveLengthMeasure::createObjectFromSTEP( args[8], map, errorStream );
	m_NominalLength = IfcPositiveLengthMeasure::createObjectFromSTEP( args[9], map, errorStream );
	m_PredefinedType = IfcMechanicalFastenerTypeEnum::createObjectFromSTEP( args[10], map, errorStream );
}
void IFC4X3::IfcMechanicalFastener::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcElementComponent::getAttributes( vec_attributes );
...
void IFC4X3::IfcMechanicalFastener::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcElementComponent::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcMechanicalFastener::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcElementComponent::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcMechanicalFastener::unlinkFromInverseCounterparts()
{
