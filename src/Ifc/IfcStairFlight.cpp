...
void IFC4X3::IfcStairFlight::getStepLine( std::stringstream& stream ) const
{
...
void IFC4X3::IfcStairFlight::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcStairFlight::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	...
	if( num_args != 13 ){ std::stringstream err; err << "Wrong parameter count for entity IfcStairFlight, expecting 13, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_NumberOfRisers = IfcInteger::createObjectFromSTEP( args[8], map, errorStream );
	m_NumberOfTreads = IfcInteger::createObjectFromSTEP( args[9], map, errorStream );
	m_RiserHeight = IfcPositiveLengthMeasure::createObjectFromSTEP( args[10], map, errorStream );
	m_TreadLength = IfcPositiveLengthMeasure::createObjectFromSTEP( args[11], map, errorStream );
	m_PredefinedType = IfcStairFlightTypeEnum::createObjectFromSTEP( args[12], map, errorStream );
}
...
void IFC4X3::IfcStairFlight::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcBuiltElement::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcStairFlight::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcBuiltElement::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcStairFlight::unlinkFromInverseCounterparts()
{
