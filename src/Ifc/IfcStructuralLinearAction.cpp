...
IFC4X3::IfcStructuralLinearAction::IfcStructuralLinearAction( int tag ) { m_tag = tag; }
void IFC4X3::IfcStructuralLinearAction::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCSTRUCTURALLINEARACTION" << "(";
...
void IFC4X3::IfcStructuralLinearAction::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcStructuralLinearAction::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 12 ){ std::stringstream err; err << "Wrong parameter count for entity IfcStructuralLinearAction, expecting 12, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IFC4X3::IfcStructuralLinearAction::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcStructuralCurveAction::getAttributes( vec_attributes );
}
void IFC4X3::IfcStructuralLinearAction::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcStructuralCurveAction::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcStructuralLinearAction::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcStructuralCurveAction::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcStructuralLinearAction::unlinkFromInverseCounterparts()
{
	IfcStructuralCurveAction::unlinkFromInverseCounterparts();
}
