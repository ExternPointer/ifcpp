...
IFC4X3::IfcStructuralPointReaction::IfcStructuralPointReaction( int tag ) { m_tag = tag; }
void IFC4X3::IfcStructuralPointReaction::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCSTRUCTURALPOINTREACTION" << "(";
...
void IFC4X3::IfcStructuralPointReaction::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcStructuralPointReaction::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcStructuralPointReaction, expecting 9, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
...
void IFC4X3::IfcStructuralPointReaction::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcStructuralReaction::getAttributes( vec_attributes );
}
void IFC4X3::IfcStructuralPointReaction::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcStructuralReaction::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcStructuralPointReaction::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcStructuralReaction::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcStructuralPointReaction::unlinkFromInverseCounterparts()
{
