...
IFC4X3::IfcSubContractResourceType::IfcSubContractResourceType( int tag ) { m_tag = tag; }
void IFC4X3::IfcSubContractResourceType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCSUBCONTRACTRESOURCETYPE" << "(";
...
void IFC4X3::IfcSubContractResourceType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcSubContractResourceType::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 12 ){ std::stringstream err; err << "Wrong parameter count for entity IfcSubContractResourceType, expecting 12, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcSubContractResourceTypeEnum::createObjectFromSTEP( args[11], map, errorStream );
}
void IFC4X3::IfcSubContractResourceType::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcConstructionResourceType::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IFC4X3::IfcSubContractResourceType::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcConstructionResourceType::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcSubContractResourceType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcConstructionResourceType::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcSubContractResourceType::unlinkFromInverseCounterparts()
{
