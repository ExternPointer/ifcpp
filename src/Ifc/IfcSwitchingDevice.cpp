...
void IFC4X3::IfcSwitchingDevice::getStepLine( std::stringstream& stream ) const
{
...
void IFC4X3::IfcSwitchingDevice::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcSwitchingDevice::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	...
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcSwitchingDevice, expecting 9, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcSwitchingDeviceTypeEnum::createObjectFromSTEP( args[8], map, errorStream );
}
