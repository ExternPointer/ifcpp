...
// ENTITY IfcTaskType 
IFC4X3::IfcTaskType::IfcTaskType( int tag ) { m_tag = tag; }
void IFC4X3::IfcTaskType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCTASKTYPE" << "(";
...
void IFC4X3::IfcTaskType::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcTaskType::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 11 ){ std::stringstream err; err << "Wrong parameter count for entity IfcTaskType, expecting 11, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcTaskTypeEnum::createObjectFromSTEP( args[9], map, errorStream );
	m_WorkMethod = IfcLabel::createObjectFromSTEP( args[10], map, errorStream );
}
void IFC4X3::IfcTaskType::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
...
void IFC4X3::IfcTaskType::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcTypeProcess::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcTaskType::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcTypeProcess::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcTaskType::unlinkFromInverseCounterparts()
{
