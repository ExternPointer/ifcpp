...
IFC4X3::IfcTransportElement::IfcTransportElement( int tag ) { m_tag = tag; }
void IFC4X3::IfcTransportElement::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCTRANSPORTELEMENT" << "(";
...
void IFC4X3::IfcTransportElement::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcTransportElement::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcTransportElement, expecting 9, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcTransportElementTypeEnum::createObjectFromSTEP( args[8], map, errorStream );
}
void IFC4X3::IfcTransportElement::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcTransportationDevice::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IFC4X3::IfcTransportElement::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcTransportationDevice::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcTransportElement::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcTransportationDevice::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcTransportElement::unlinkFromInverseCounterparts()
{
	IfcTransportationDevice::unlinkFromInverseCounterparts();
}
