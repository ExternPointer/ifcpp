...
// ENTITY IfcVehicle 
IFC4X3::IfcVehicle::IfcVehicle( int tag ) { m_tag = tag; }
void IFC4X3::IfcVehicle::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCVEHICLE" << "(";
...
void IFC4X3::IfcVehicle::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcVehicle::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcVehicle, expecting 9, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcVehicleTypeEnum::createObjectFromSTEP( args[8], map, errorStream );
}
void IFC4X3::IfcVehicle::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcTransportationDevice::getAttributes( vec_attributes );
	vec_attributes.emplace_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IFC4X3::IfcVehicle::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcTransportationDevice::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcVehicle::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcTransportationDevice::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcVehicle::unlinkFromInverseCounterparts()
{
