...
IFC4X3::IfcWallStandardCase::IfcWallStandardCase( int tag ) { m_tag = tag; }
void IFC4X3::IfcWallStandardCase::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCWALLSTANDARDCASE" << "(";
...
void IFC4X3::IfcWallStandardCase::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcWallStandardCase::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcWallStandardCase, expecting 9, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcWallTypeEnum::createObjectFromSTEP( args[8], map, errorStream );
}
void IFC4X3::IfcWallStandardCase::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
	IFC4X3::IfcWall::getAttributes( vec_attributes );
}
void IFC4X3::IfcWallStandardCase::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcWall::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcWallStandardCase::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcWall::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcWallStandardCase::unlinkFromInverseCounterparts()
{
	IfcWall::unlinkFromInverseCounterparts();
}
