...
// ENTITY IfcWindow 
IFC4X3::IfcWindow::IfcWindow( int tag ) { m_tag = tag; }
void IFC4X3::IfcWindow::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_tag << "= IFCWINDOW" << "(";
...
void IFC4X3::IfcWindow::getStepParameter( std::stringstream& stream, bool /*is_select_type*/ ) const { stream << "#" << m_tag; }
void IFC4X3::IfcWindow::readStepArguments( const std::vector<std::string>& args, const std::map<int,shared_ptr<BuildingEntity> >& map, std::stringstream& errorStream )
{
	const size_t num_args = args.size();
	if( num_args != 13 ){ std::stringstream err; err << "Wrong parameter count for entity IfcWindow, expecting 13, having " << num_args << ". Entity ID: " << m_tag << std::endl; throw BuildingException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcWindowTypeEnum::createObjectFromSTEP( args[10], map, errorStream );
	m_PartitioningType = IfcWindowTypePartitioningEnum::createObjectFromSTEP( args[11], map, errorStream );
	m_UserDefinedPartitioningType = IfcLabel::createObjectFromSTEP( args[12], map, errorStream );
}
void IFC4X3::IfcWindow::getAttributes( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes ) const
{
...
void IFC4X3::IfcWindow::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<BuildingObject> > >& vec_attributes_inverse ) const
{
	IFC4X3::IfcBuiltElement::getAttributesInverse( vec_attributes_inverse );
}
void IFC4X3::IfcWindow::setInverseCounterparts( shared_ptr<BuildingEntity> ptr_self_entity )
{
	IfcBuiltElement::setInverseCounterparts( ptr_self_entity );
}
void IFC4X3::IfcWindow::unlinkFromInverseCounterparts()
{
